...
<body id="programm">
	<?php include "../inc/header.inc"; ?>
        ...
        <p><a href="programm/donnerstag.php#session_lightning_talks_2">&#9668; zurück zum Programm</a></p>
        <section>
        ...
        <ul>
                    <li>Johannes Kröger: <span class='subsession-title'><a href="sessions/RQMALK.php">Leider immer noch kein LiDAR?</a></span>
                            </li>
                    <li>Christopher Lorenz: <span class='subsession-title'><a href="sessions/UZQF9G.php">Bikeparking - Vergleich von Fahradparkplätzen zwischen OpenData und OpenStreetMap</a></span>
                            </li>
