...
<body id="programm">
	<?php include "../inc/header.inc"; ?>
        ...
        <p><a href="programm/donnerstag.php#session_L9NGAN">&#9668;&#9668; zurück zum Programm</a> </p>
        <h2 class='abstract-title'>GeoPortal Koblenz – digital, vielschichtig, maßgebend</h2>
        <section>
            <p>
                                <span class='abstract-speakers'>Torsten Brassat, Andreas Weckbecker, Christine Dolezich</span></p>
...
<p>Die Präsentation gibt vertiefte Einblicke zur genannten Thematik.</p>
        <div class='abstract-bio'>
            <h3 class='abstract-bio-name'>Torsten Brassat</h3>
            <p>Ich habe mich in der Vergangenheit wie folgt in der FOSSGIS Community
eingebracht:</p>
<ul>
<li>Mitorganisation der FOSSGIS Konferenzen 2006-2010</li>
<li>Mitorganisation des OpenSource auf der Intergeo 2006-2007</li>
<li>Mitorganisation der FOSS4G 2016 in Bonn</li>
</ul>
<p>Angestellt bin ich als Geschäftsführer von <a href="https://www.terrestris.de/">terrestris</a> und <a href="https://www.mundialis.de/">mundialis</a>,
spezialisierte IT Firmen auf OpenSource GIS- und Fernerkundungslösungen aus Bonn.</p>
        </div>
        <div class='abstract-bio'>
