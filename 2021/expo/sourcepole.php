...
<body id="expo">
	...
	<section class="section">
		<div class="container">
			<img src="./expo/img/csm_sunset_sourcepole.jpg" class="img-fluid" alt="sourcepole_Headerbild">
			<div class="row">
				<div class="col-lg-9 mb-4 mb-lg-0 mt-3">
					<h3>Sourcepole</h3>
					<p>Sourcepole entwickelt kundenspezifische Lösungen im Bereich Geoinformatik. Wir erweitern und integrieren Open Source Software nach Ihren Bedürfnissen.
Als offizielle Commiter in mehreren OSGeo-Projekten können wir auch direkt in den Original-Code eingreifen.
				...
				<div class="col-lg-3">
					<div class="icon mt-3">
						<img src="./img/s/407_sourcepole_block2.png" title="Sourcepole" alt="Sourcepole">
					</div>
					<div class="mb-4">
					...
					<div class="mb-4">
						...
						<a href="https://www.sourcepole.ch/">
							https://www.sourcepole.ch/</a>
					</div>
