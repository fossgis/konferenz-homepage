		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-9 mb-4 mb-lg-0 mt-3">
					...
					<p>In den letzten Jahren hat Esri OSM Daten in ArcGIS leichter zugänglich gemacht. Esri hostet eine Live-Replik der OpenStreetMap (OSM)-Daten und führte seit über zwei Jahren eine neue OpenStreetMap Vector Basemap ein. Die Karte wird ausschließlich mit OSM-Daten erstellt und ist für alle Benutzer frei verfügbar. Mit dem <u><a href="https://developers.arcgis.com/vector-tile-style-editor/">Vector Tile Style Editor</a></u> können Developers die OpenStreetMap-Basiskarte auch anpassen. In Zusammenarbeit mit Facebook ermöglicht die aktuelle Version von <u><a href="https://wiki.openstreetmap.org/wiki/RapiD">RapiD</a> </u> und dem <u><a href="https://gitlab.com/gokaart/JOSM_MapWithAI/-/wikis/Testing-the-development-version">MapWithAI Plugin</a></u> den Zugang zu einer Sammlung offener ArcGIS-Datensätze, die von den Regierungen der lokalen Gebiete freigegeben wurden. Dies bedeutet, dass für die Bearbeitung genauere Gebäudeumrisse oder Hausnummern hinzugefügt werden können.</p>
