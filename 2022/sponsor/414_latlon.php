...
<head>
	...
	<title>FOSSGIS 2022 - Sponsor lat/lon GmbH</title>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-9 mb-4 mb-lg-0 mt-3">
					...
					<p>Als Teil der deegree Community engagieren wir uns aus Überzeugung im FOSSGIS e.V. und in der OSGeo Foundation. lat/lon ist Mitglied im Open Geospatial Consortium (OGC) und arbeitet aktiv an der Weiterentwicklung der OGC TEAM Engine im Rahmen des CITE Projekts mit.</p>
				...
				<div class="col-lg-3">
					<div class="mb-4">
						...
						<a href="https://www.lat-lon.de/ ">
							https://www.lat-lon.de/ </a><br>

							E-Mail: <br>
							<a href="mailto:info@lat-lon.de">info@lat-lon.de</a><br>
							Adresse:<br>
							lat/lon GmbH<br>
							Aennchenstrasse 19<br>
							53177 Bonn, Germany<br>
							Telefon: +49 228 9477 9877<br>
										</h6>
					</div>
