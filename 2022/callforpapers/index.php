...
Konferenzveranstalter sind der gemeinnützige FOSSGIS e.V., die OpenStreetMap-Community und die Phillipps Universität Marburg.</p>
	...
	<p>Das Konferenzprogramm beinhaltet folgende Formate:</p>
	<ul>
...
Workshops dauern 90 Minuten und finden von Mittwoch bis Freitag parallel zu den Vorträgen statt. Die Teilnahme am Workshop ist kostenpflichtig, die Teilnehmer:innenzahl begrenzt.
...
Ihre Einreichung passt nicht zu einem der Einreichungstypen? Oder Sie wünschen ein Gutachten (Peer-Review). Dann setzen Sie sich bitte vor dem Ende der Einreichungsfrist mit dem Programm-Komitee per <a href="mailto:pko@fossgis.de? subject=Frage%an%das%Programmkomitee"> per E-Mail</a> in Verbindung.</li>
	...
	<p>Sollte die Infektionslage der Durchführung einer Konferenz vor Ort im Wege stehen, wird die FOSSGIS eine reine Online-Konferenz werden. Um Programmänderungen zu vermeiden, erwarten wir daher von allen Beitragenden, in solch einem Fall aus der Ferne vorzutragen.<br>
Nach Erfahrung der FOSSGIS 2021 präferieren wir eine Aufzeichnung vorab, Sie sollten trotzdem während der Vortragszeit anwesend sein und im Anschluss an den Vortrag für Fragen zur Verfügung stehen.</p>

	<p>Wir bitten Sie bei der Einreichung anzugeben, ob Sie planen vor Ort oder aus der Ferne teilzunehmen. <br>
Für diejenigen, die vor Ort teilnehmen wollen, ist zu berücksichtigen, dass Sie zum Zeitpunkt der Konferenz einen entsprechenden Genesenen- oder Impfnachweis vorweisen müssen. Es ist geplant die Konferenz unter der 2G-Regel stattfinden zu lassen.</p>



	<h2>Konferenzticket, Verfügbarkeit und Reisekosten</h2>

	<p>Vortragende und Workshopleitende erhalten einen Gutscheincode für ein kostenloses Konferenz-Ticket.</p>
	...
	<ul>
		...
		<li>Mirko Blinn (Wissenschaftlicher Mitarbeiter  an der Universität Bonn und EDV. Servicestelle der Biologischen Stationen in NRW)</li>
	...
	<ul>
		<li>am 21. November 2021 endet der Call for Participation (Achtung: keine Verlängerung)</li>
		<li>November 2021: Community-Voting</li>
		<li>November bis Dezember 2021: Bewertung und Programmgestaltung durch das Programm-Komitee</li>
		<li>bis Mitte Dezember 2021: Benachrichtigung der Vortragenden (Zusagen/Absagen)</li>
		<li>Januar 2022: Programmveröffentlichung und Start des Ticketverkaufs</li>
		<li>Februar 2022: Beitrag für Tagungsband einreichen</li>
		<li>9.-12. März 2022: FOSSGIS-Konferenz 2022</li>
	</ul>
	...
	<p>Wir freuen uns auf Ihre Einreichung.</p>

	<p>Das FOSSGIS 2022 Programm-Komitee</p>
