...
<head>
	...
	<title>FOSSGIS 2025 - Sponsor Bundesamt für Kartographie und Geodäsie (BKG)</title>
...
<body id="expo">
	...
	<section class="section">
		<div class="container">
			...
			<img src="./img/s/102_BKG_Logo_RGB.png" 
				class="sp-logo" 
				alt="Firmenlogo">
...
Das BKG ist in Frankfurt am Main beheimatet und unterhält eine Außenstelle in Leipzig sowie geodätische Observatorien im In- und Ausland.</p>
				...
				<div class="col-lg-3">
					...
					<div class="social-icon">
						...
						<ul>
						<li>
						<a href="https://www.linkedin.com/company/bkg-bund"><i class="fab fa-linkedin"></i></a>
						</li>
						<li>
						<a href="https://www.instagram.com/bkg.bund"><i class="fab fa-instagram"></i></a>
						</li>
						<li>
						...
						<li>
						<a href="https://twitter.com/BKG_Bund"><i class="fab fa-x-twitter"></i></a>
						</li>
